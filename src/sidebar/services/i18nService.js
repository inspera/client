...
function i18nService() {
  ...
  const languageMapIetfToInsperaContent = {
    'en-US': 'en_us',
    'nb-NO': 'no_no',
    'nn-NO': 'no_no_ny',
    'pl-PL': 'pl_pl',
  ...
  function getInitialLanguage() {
    const languageFromLocalStorage = languageMapInsperaToIetf[
   ...
   *
   * @param {string} language IETF language code, eg: en-US or nn-NO
   * @param {function} callback
  */
  function changeLanguage(language, callback) {
    localStorage.setItem(
      'locale',
      languageMapIetfToInsperaContent[language]
    );
